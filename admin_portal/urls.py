...
from .views import (
                     ...
                     billing_category_list, billing_category_edit,
                     student_reward_list, student_reward_edit,
                     reward_category_create, billing_category_create,
                     account_status_list,
                     ...
                     material_create_view, material_edit_view,
                     )
...
urlpatterns = [
    ...
    path('reward-settings/billing/', billing_category_list, name='billing_category_list'),
    path('reward-settings/billing/<int:pk>/edit/', billing_category_edit, name='billing_category_edit'),
    path('reward-settings/billing/new/', billing_category_create, name='billing_category_create'),
